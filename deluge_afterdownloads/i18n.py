...
ENGLISH = {
    ...
    'Требуются Linux с systemd/logind, busctl и systemd-inhibit.': 'Linux with systemd/logind, busctl and systemd-inhibit is required.',
    ...
    'Linux/systemd: сон и гибернация на реальном устройстве — NOT TESTED.': 'Linux/systemd: Sleep and Hibernate on a real device — NOT TESTED.',
